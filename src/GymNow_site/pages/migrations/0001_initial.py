# Generated by Django 2.2.17 on 2021-03-20 18:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='EUR', max_digits=14)),
                ('category', models.CharField(choices=[('Gym Booking', 'Gym Booking'), ('Personal Trainer', 'Personal Trainer'), ('Pilates', 'Pilates'), ('Yoga', 'Yoga'), ('Crossfit', 'Crossfit')], max_length=200, null=True)),
